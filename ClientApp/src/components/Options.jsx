    ...
    return(
        <section className="option-section">
            ...
            <div className="option-section-btn">
                <BtnOption text="Sonido" widthImg="26" heightImg="20" img={sound} color1="rgb(0, 32, 202, 1)" color2="rgba(0, 50, 255, 0.24)"></BtnOption>
                <BtnOption text="Oxigeno" widthImg="19" heightImg="14" img={oxigeno} color1="rgb(6, 184, 142, 1)" color2="rgba(6, 184, 142, 0.24)"></BtnOption>
                <BtnOption text="Sensation" widthImg="15" heightImg="15" img={temperatura} color1="rgb(161, 6, 192, 1)" color2="rgba(213, 0, 255, 0.24)"></BtnOption>
            </div>
