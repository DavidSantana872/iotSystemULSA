...
const PointAlert = ({show, positionValue, metric}) => {
   ...
   const point1Color = () => {
        if(metric === "Sonido"){
            return 'rgb(0,72,255, 0.14)'
        }
        else if(metric === "Oxigeno"){
            return 'rgb(6, 184, 142, 0.14)'
        }
        else{
            return 'rgb(161, 6, 192, 0.14)'
        }
   }
   const point2Color = () => {
        if(metric === "Sonido"){
            return 'rgb(0,72,255, 0.29)'
        }
        else if(metric === "Oxigeno"){
            return 'rgb(6, 184, 142, 0.29)'
        }
        else{
            return 'rgb(161, 6, 192, 0.29)'
        }
    }
    const point3Color = () => {
        if(metric === "Sonido"){
            return 'rgb(0, 72, 255, 0.35)'
        }
        else if(metric === "Oxigeno"){
            return 'rgb(6, 184, 142, 0.35)'
        }
        else{
            return 'rgb(161, 6, 192, 0.35)'
        }
    }
